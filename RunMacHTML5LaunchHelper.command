...
EPIC_MONO=""
if [ -f "D:\UNREALPROGRAM2019\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\UNREALPROGRAM2019\UE_4.22\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'D:\UNREALPROGRAM2019\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
